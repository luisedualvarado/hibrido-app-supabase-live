...
const RESTRICTIONS = {
  'Escobar, Andrea':       { restrictionType: 'ODD_DAYS', notes: 'Restriccion aprobada.' },
  'Cardenas, Jaime':       { restrictionType: 'EVEN_DAYS', notes: 'Restriccion aprobada.' },
  'Hernandez, Ivonne':     { restrictionType: 'ODD_DAYS', notes: 'Restriccion aprobada.' },
  'Jimenez, Johana':       { restrictionType: 'EVEN_DAYS', restrictionEnabled: false, notes: 'Restriccion aprobada.' },
  'Morales, Jonathan':     { restrictionType: 'FIXED_DAY', fixedDay: 'THURSDAY', restrictionEnabled: false, notes: 'Restriccion aprobada.' },
  'Escobar, Andrés':       { restrictionType: 'FIXED_DAY', fixedDay: 'WEDNESDAY', restrictionEnabled: false, notes: 'Restriccion aprobada.' },
  'Hilario, Martin':       { restrictionType: 'FIXED_DAY', fixedDay: 'WEDNESDAY', restrictionEnabled: false, notes: 'Restriccion aprobada.' },
  'Rodriguez, Sofia':      { restrictionType: 'PENDING', notes: 'Pendiente por verificar (¿lunes? día SENA).' },
  'Salazar, Diego':        { restrictionType: 'ALLOWED_DAYS', allowedDays: ['TUESDAY', 'WEDNESDAY'], restrictionEnabled: false, notes: 'Restriccion aprobada.' },
  'Camargo, Jessel':       { restrictionType: 'ODD_DAYS', notes: 'Restriccion aprobada.' },
